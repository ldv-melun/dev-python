...
Voici un programme python faisant usage de caractères unicode non conventionnels, n'ayant pas toujours un glyphe associé !! C'est une technique d'*obfuscation de code source*, bien connue des hackers malveillants.
